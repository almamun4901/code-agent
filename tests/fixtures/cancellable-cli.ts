  ...
  return {
    content: [{
      ...
      input: {
        ...
        acceptanceCriteria: [{ id: "cancel", criterion: "Cancellation reaches terminal cleanup.", verification: "Observe lifecycle output.", verificationRequirementIds: ["cancel-check"] }],
